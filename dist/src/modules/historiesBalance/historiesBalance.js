...
const GET_LIST = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (limit && page) {
            const historiesBalanceList = yield model_1.default.historiesBalanceList(limit, page);
...
const GET_USER_ID = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const foundHistoriesBalance = yield model_1.default.foundHistoriesBalance(id);
