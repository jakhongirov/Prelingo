...
const cron_2 = require("./src/lib/cron/cron");
...
const passport_1 = __importDefault(require("./src/lib/passport"));
...
const job = new cron_1.CronJob('0 4 * * *', () => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, cron_2.countBonus)();
